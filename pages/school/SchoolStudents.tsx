/**
 * SchoolStudents — Phase 12 / 19.4C
 *
 * Students enrolled at this school admin's school.
 * Read-only view — school admin cannot modify student records.
 * Table layout mirrors the admin Students page, scoped to the admin's own school.
 */
...
export const SchoolStudents: React.FC = () => {
  const { students, teachers, schools, lessons, enrollments, schoolEnrollmentPeriods } = useApp(); // already filtered by schoolId
  ...
  const filtered = useMemo(() => {
    ...
    return result;
  }, [enrichedStudents, gradeFilter, search]);
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <div className="relative flex-1 min-w-[200px] max-w-sm">
          ...
          <input
            ...
            placeholder="Search name, instrument, teacher, email..."
                ...
                {filtered.map(student => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 text-slate-400 text-xs">
                      {student.yearGrade ? `Grade ${student.yearGrade}` : <span className="text-slate-600">—</span>}
                    </td>
                    <td className="px-5 py-3.5">
