        ...
        <div className="bg-slate-900/80 backdrop-blur rounded-2xl ring-1 ring-white/8 shadow-2xl shadow-black/40 p-8">
          ...
          {showAppleSignIn && (
            <button
              ...
              disabled={loading}
              className="w-full mt-3 bg-slate-800/80 hover:bg-slate-700/80 border border-slate-700/80 text-white font-medium py-3 rounded-xl transition-all flex items-center justify-center gap-3 disabled:opacity-50 text-sm active:scale-[0.98]"
            >
